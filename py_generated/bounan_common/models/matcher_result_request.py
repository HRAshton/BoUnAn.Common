...
class MatcherResultRequest(BaseModel):
    """
    Request to send the result of the matching
    """ # noqa: E501
    items: List[MatcherResultRequestItem] = Field(alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [MatcherResultRequestItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
