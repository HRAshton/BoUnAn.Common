...
class VideoRegisteredNotification(BaseModel):
    """
    Notification that a video has been registered (for multiple videos at once)
    """ # noqa: E501
    items: List[VideoRegisteredNotificationItem] = Field(alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [VideoRegisteredNotificationItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
