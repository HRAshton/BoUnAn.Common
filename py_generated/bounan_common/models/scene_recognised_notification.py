...
class SceneRecognisedNotification(BaseModel):
    """
    Notification that video scenes have been recognised (for multiple videos at once)
    """ # noqa: E501
    items: List[SceneRecognisedNotificationItem] = Field(alias="Items")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [SceneRecognisedNotificationItem.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None
        })
